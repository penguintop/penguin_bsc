...
import (
	...
	"errors"
	"fmt"
	"github.com/penguintop/penguin_bsc/pkg/factoryabi"
	"math/big"
...
var (
	...
	factoryABI                  = transaction.ParseABIUnchecked(factoryabi.FactoryABIv0_1_0)
...
var currentDeployVersion []byte = common.FromHex(factoryabi.FactoryDeployedBinv_0_1_0)
