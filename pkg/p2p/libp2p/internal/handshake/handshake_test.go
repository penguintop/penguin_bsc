...
import (
	...
	"github.com/penguintop/penguin_bsc/pkg/p2p/libp2p/internal/handshake"
	"github.com/penguintop/penguin_bsc/pkg/p2p/libp2p/internal/handshake/mock"
	"github.com/penguintop/penguin_bsc/pkg/p2p/libp2p/internal/handshake/pb"
...
func TestHandshake(t *testing.T) {
	...
	node1BzzAddress, err := pen.NewAddress(signer1, node1ma, addr, networkID)
	if err != nil {
		t.Fatal(err)
	}
	...
	node2BzzAddress, err := pen.NewAddress(signer2, node2ma, addr2, networkID)
	if err != nil {
		t.Fatal(err)
	}
