...
import (
	...
	"errors"
	"fmt"
	"github.com/penguintop/penguin_bsc/pkg/auditor"
	"github.com/penguintop/penguin_bsc/pkg/property"
	"github.com/penguintop/penguin_bsc/pkg/staking"
	"io"
	"log"
	"math/big"
	"net"
	...
	"github.com/penguintop/penguin_bsc/pkg/addressbook"
	"github.com/penguintop/penguin_bsc/pkg/api"
	"github.com/penguintop/penguin_bsc/pkg/crypto"
	"github.com/penguintop/penguin_bsc/pkg/debugapi"
	"github.com/penguintop/penguin_bsc/pkg/feeds/factory"
	...
	"github.com/penguintop/penguin_bsc/pkg/p2p/libp2p"
	"github.com/penguintop/penguin_bsc/pkg/penguin"
	"github.com/penguintop/penguin_bsc/pkg/pingpong"
	"github.com/penguintop/penguin_bsc/pkg/pinning"
	"github.com/penguintop/penguin_bsc/pkg/postage"
	"github.com/penguintop/penguin_bsc/pkg/postage/batchservice"
	"github.com/penguintop/penguin_bsc/pkg/postage/batchstore"
	"github.com/penguintop/penguin_bsc/pkg/postage/listener"
	"github.com/penguintop/penguin_bsc/pkg/postage/postagecontract"
	"github.com/penguintop/penguin_bsc/pkg/pricer"
	"github.com/penguintop/penguin_bsc/pkg/pricing"
	"github.com/penguintop/penguin_bsc/pkg/pss"
	"github.com/penguintop/penguin_bsc/pkg/puller"
	"github.com/penguintop/penguin_bsc/pkg/pullsync"
	"github.com/penguintop/penguin_bsc/pkg/pullsync/pullstorage"
	...
	"github.com/penguintop/penguin_bsc/pkg/resolver/multiresolver"
	"github.com/penguintop/penguin_bsc/pkg/retrieval"
	"github.com/penguintop/penguin_bsc/pkg/settlement/pseudosettle"
	"github.com/penguintop/penguin_bsc/pkg/settlement/swap"
	"github.com/penguintop/penguin_bsc/pkg/settlement/swap/chequebook"
	"github.com/penguintop/penguin_bsc/pkg/shed"
	"github.com/penguintop/penguin_bsc/pkg/steward"
	...
	"github.com/penguintop/penguin_bsc/pkg/topology/kademlia"
	"github.com/penguintop/penguin_bsc/pkg/topology/lightnode"
	"github.com/penguintop/penguin_bsc/pkg/tracing"
	"github.com/penguintop/penguin_bsc/pkg/transaction"
	"github.com/penguintop/penguin_bsc/pkg/traversal"
...
func NewPen(addr string, penguinAddress penguin.Address, publicKey ecdsa.PublicKey, signer crypto.Signer, networkID uint64, logger logging.Logger, libp2pPrivateKey, pssPrivateKey *ecdsa.PrivateKey, o Options) (b *Pen, err error) {
	...
	if o.DebugAPIAddr != "" {
		...
		debugAPIService = debugapi.New(penguinAddress, publicKey, pssPrivateKey.PublicKey, overlayEthAddress, logger, tracer, o.CORSAllowedOrigins)
	...
	if !o.Standalone {
		swapBackend, overlayEthAddress, penguinNodeAddress, chainID, transactionMonitor, transactionService, err = InitChain(
			p2pCtx,
			logger,
			stateStore,
			o.SwapEndpoint,
	...
	if o.AuditNodeMode && o.AuditEndpoint != "" {
		...
		stakingContractAddress.SetBytes(common.FromHex(property.StakingAddress))
		...
		adt := auditor.CreateNewAuditor(o.AuditEndpoint, storer, signer, chainID, logger)
		go adt.Run()
	}
