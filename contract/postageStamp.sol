...
// File @openzeppelin/contracts/GSN/Context.sol@v3.2.2-solc-0.7
...
// File @openzeppelin/contracts/token/ERC20/ERC20.sol@v3.2.2-solc-0.7
...
// File @openzeppelin/contracts/utils/EnumerableSet.sol@v3.2.2-solc-0.7
...
// File @openzeppelin/contracts/access/AccessControl.sol@v3.2.2-solc-0.7
...
// File @openzeppelin/contracts/utils/Pausable.sol@v3.2.2-solc-0.7
...
contract PostageStamp is AccessControl, Pausable {
    ...
    // The address of the PEN ERC20 token this contract references.
    address public penToken;
    ...
    /**
     * @param _penToken The ERC20 token address to reference in this contract.
     */
    constructor(address _penToken) {
        penToken = _penToken;
    ...
    function createBatch(
        ...
        require(ERC20(penToken).transferFrom(msg.sender, address(this), totalAmount), "failed transfer");
